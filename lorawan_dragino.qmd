...
# Optional overrides via ENV or .env: CSV, FPORT, DELAY_BETWEEN_DEV
# ==============================================================================
...
# NEW: simple per-device delay (seconds). No jitter.
DELAY_BETWEEN_DEV="${DELAY_BETWEEN_DEV:-1.0}"
...
while IFS=, read -r DEV MINUTES EXT; do
  ...
  # NEW: simple delay between devices (no jitter)
